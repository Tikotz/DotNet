    ...
    class Program
    {
        ...
        public static void MainGame(int len)
        {
            ...
            while ((First_Score + Second_Score) != (len * len)/2 )
            {
                ...
                LineCard1 = int.Parse(Console.ReadLine()) -1;
                ColunCard1 = int.Parse(Console.ReadLine()) -1;
                ...
                LineCard2 = int.Parse(Console.ReadLine()) -1;
                ColunCard2 = int.Parse(Console.ReadLine()) -1;
                ...
                if(Board_Arr[LineCard1, ColunCard1] == Board_Arr[LineCard2, ColunCard2])
                {
                    ...
                    {
                        First_Score++;
                        Console.WriteLine("first player score is: {0} ",First_Score);
                    }
                    else
                    {
                        Second_Score++;
                        Console.WriteLine("second player score is: {0} ", Second_Score);
                    }
                    Board(Board_Arr);
